...
const mail = async (user, id, token, email) => {
  console.log("mail data", user, id, token, email);
  ...
  const link = `http://localhost:3004/${user}/reset-password/${id}/${token}`;

  console.log("link", link);
  //   const link = `${process.env.url}/${user}/reset-password/${id}/${token}`;
                                                                    ...
                                                                    <div style="font-family: sans-serif">
                                                                        <div class="txtTinyMce-wrapper"
                                                                            ...
                                                                            <p
                                                                                ...
                                                                                <span style="font-size:16px;">Reset password link has been generated. Please click below to reset password. </span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                                ...
                                                                <td class="pad">
                                                                    <div
                                                                        ...
                                                                        <p style="margin: 0;"><span
                                                                                style="color: #ffffff;">2022 virifi.io All
  ...
  let resPonse = await setup.sendMail(mailOption, (error, info) => {
    if (error) {
      console.log({ Error: error });
      return { Error: error };
    }
    let mailRes = info;
    console.log("mal res ", mailRes);
    return mailRes;
  });
  //   return mailRes
};
